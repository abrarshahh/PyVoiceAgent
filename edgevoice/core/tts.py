...
from edgevoice.core.config import GENERATED_AUDIO_DIR
    ...
    def get_tts_model(cls):
        if cls._instance_tts is None:
            ...
            try:
                ...
                raise NotImplementedError("TTS model requires chatterbox-tts, which is dropped. piper-tts lands in Phase 1.")
            try:
